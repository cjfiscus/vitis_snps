...
#SBATCH --job-name="call2"
#SBATCH -p gcluster
#SBATCH --array=656,658

# 584-696 will be array
...
SEQLIST=/gpool/cfiscus/vitis_snps/data/bam_2_gvcf_lst2.txt
...
NUM=$(echo $SLURM_ARRAY_TASK_ID - 582 | bc) 
